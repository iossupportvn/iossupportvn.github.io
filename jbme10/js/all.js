...
var Struct = function() {
    ...
    return {
        ...
        unpack: function(a, e) {
            if (e.length !== a.BYTES_PER_ELEMENT)
...
function str2ab(a) {
    for (var d = new ArrayBuffer(2 * a.length), e = new Uint16Array(d), h = 0, v = a.length; h < v; h++)
        e[h] = a.charCodeAt(h);
    return d
}
;/\b10_\S+ like Mac OS X/.test(navigator.userAgent) || (window.crypto.subtle || window.crypto.webkitSubtle).digest({
    ...
    if ("9e04130fa02fc3c416f28ba556f0165da4d93054" != hexlify(new Uint8Array(a)))
        throw null;
}).catch(function() {
    document.title = "Incompatible Spyware";
    for (var a = document.body; a.firstChild; )
    ...
    function d(a, e) {
        return function() {
            ...
            for (var d = 0; d < arguments.length; d++)
                arguments[d]instanceof Int64 || (arguments[d] = new Int64(arguments[d]));
...
(function() {
    function a(a, d) {
        ...
        for (var e = 0; e < a.length; ++e) {
            var f = a[e].fileoff
              , q = Add(f, a[e].size);
            if ((f.hi() < d.hi() || f.hi() == d.hi() && f.lo() <= d.lo()) && (q.hi() > d.hi() || q.hi() == d.hi() && q.lo() > d.lo()))
    ...
    window.spyware = function(q, f, m) {
        ...
        for (var l = 0; l < G; ++l) {
            ...
            n.push(g);
            0 != g.fileoff.hi() || 0 != g.fileoff.lo() || 0 == g.size.hi() && 0 == g.size.lo() || (x = g)
        }
        ...
        for (l = 0; l < u; ++l) {
            ...
            0 != p.hi() || 0 != p.lo())) {
                ...
                A = m.readInt64(g + 40);
                L = m.readInt64(g + 56);
                if (t.hi() < p.hi() || t.hi() == p.hi() && t.lo() <= p.lo())
                    p = t;
                n.push({
                    addr: Sub(H, w),
                    size: p,
        ...
        for (g = 0; g < l.length; g++) {
            ...
            if ("debug_with_vtab_smash" == param[0]) {
                if (!confirm("You are running a debug feature, which will cause instability, if you weren't instructed to do so, please stop using it!"))
                    throw alert("Ok pls remove the arg and reload the site"),
                    "stop yo";
        ...
        /\b10_\S+ like Mac OS X/.test(navigator.userAgent) ? (O(Y, X, K, B, new Int64(0), new Int64(7)),
        O(C, K, r, B)) : (x.lo() || x.hi() ? O(x, Sub(K, R), r, B) : fail("bi0n1c (c)"),
